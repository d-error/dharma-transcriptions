...
def validate_and_download_audio():
    ...
    for txt_file in reference_files:
        ...
        try:
            ...
            print(
                f'[ERRO] Falha ao baixar ou mover áudio para {txt_file}: {e}'
            )
            continue
...
def prepare_data_for_training(pairs):
    ...
    for txt_file, audio_file in pairs:
        ...
        print(
            f'[INFO] Usando texto corrigido: {txt_file} '
            f'para o áudio: {audio_file}'
        )
        ...
        if not os.path.exists(bruto_file_path):
            ...
            try:
                ...
                print(
                    f'[ERRO] Falha ao transcrever áudio para {audio_file}: {e}'
                )
        else:
